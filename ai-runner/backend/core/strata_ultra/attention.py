...
class LowBitAttention:
    ...
    def __init__(self, width: int, capacity_tokens: int, mode: str = "sign1"):
        self.width = width
        self.keys = UltraKVCache(width, capacity_tokens, mode)
        self.values = UltraKVCache(width, capacity_tokens, mode)
